    ...
    return (
        <div className="grid grid-cols-3 gap-8 p-4">
            <div className="bg-red-600 p-6 flex gap-4 justify-between rounded-md">
                <div className="flex flex-col items-start gap-2 justify-evenly text-white w-full">
            ...
            <div className="bg-blue-600 p-6 flex gap-4 justify-between rounded-md">
                <div className="flex flex-col gap-2 items-start justify-evenly text-white w-full">
